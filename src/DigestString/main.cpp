...
#define PROJ_NAME            "DigestString"
#define PROJ_VER             "0.1"
#define PROJ_YEARS           "2025"
...
void version(){
    std::cout << PROJ_NAME << " version " << PROJ_VER << " (compiled " << __TIME__ << ", " << __DATE__ ")" << std::endl;
    std::cout << "Copyright (c) " << PROJ_YEARS << " " <<  AUTHOR << ". All rights reserved. " << AUTHOR_CONTACT << std::endl;
}

void help() {
    std::cout << "[USAGE]" << std::endl;
    std::cout << "\tdigestStr <OPTION> <string> ...\n" << std::endl;
